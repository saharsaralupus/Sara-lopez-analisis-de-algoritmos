...
* **Implementación base:** [Ver código de algoritmos.py (Insertion Sort)](algoritmos.py)
...
#### Gráficas de Rendimiento
![Comparaciones vs Tamaño](./graficas/parte4_tiempo.png)
...
Teniendo en cuenta que actualmente al seguir los ejercicios de clase almaceno algunos laboratorios en un directorio general para mantener el orden de los proyectos, la ruta exacta de este laboratorio en mi entorno de trabajo es `laboratorio/lab1-fundamentos-complejidad-recurrencias`, ya que esto me permite organizar todo el flujo de la materia dentro de esa carpeta de laboratorios, evitando que los archivos se mezclen con otros procesos o automatizaciones y facilitando la ejecución de los scripts referenciados anteriormente.